...
<div className='col-6'>
        ...
        <ul className='nav'>
            <li className='mh active'><a href='#'>Received</a></li>
            <li className='mh'><a href='#'>Accepted</a></li>
            <li className='mh'><a href='#'>Requests</a></li>
            <li className='mh'><a href='#'>sent</a></li>
        </ul>
...
<span><LockOutlinedIcon/></span><p>Nirjala has sent you a message. In the interest of our Premium Members, we allow only Premium users to read messages.</p>
<a className='lovv'>Upgrade Now<KeyboardArrowRightIcon/></a>
</div>
